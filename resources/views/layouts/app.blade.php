...
<body>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm p-0">
            <div class="container">
                <a class="navbar-brand p-0" href="{{ url('/') }}">
                    <img src="/img/ProWeb.png" alt="" style="width:100px; border: 2% solid;
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            {{-- @if (Route::has('register')) --}}
                                <li class="nav-item">
                                    <strong><a class="nav-link" href="/registro">{{ __('Register') }}</a></strong>
                                </li>
                            {{-- @endif
                        @else
    ...
    <script src="list-provincias"></script>
</body>
</html>
